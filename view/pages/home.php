    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            ...
            <li data-target="#carouselExampleIndicators" data-slide-to="<?php echo $ban['id']?>"
                <?php if($ban['id'] == 1){echo 'class="active"'; }?>></li>
            <?php }?>
        </ol>
        <div class="carousel-inner">
            <?php foreach($banner as $ban){?>
            <div class="carousel-item <?php if($ban['id'] == 1){echo 'active'; }?>">
                <img width="1600" height="500" class="d-block w-100" src="<?php echo $ban['image']?>">
            </div>
            <?php }?>
        </div>
    ...
    <!-- Banner Section Begin -->
    <section class="banner set-bg" data-setbg="assets/img/banner/banner_1.jpg">
        <div class="container">
            <div class="row">
